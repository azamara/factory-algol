...
class JTSplashView: UIView {
    ...
    - parameter  backgroundColor: Background color of the splash view. Default is asphalt color.
    - parameter  circleColor: Color of the animated circle. Default is blue color.
    - parameter  circleSize: Size of the animated circle. 10pt border will be added, but the size remains the same. Width should be same as height. Default is CGSize(70, 70).
    */
    ...
    */
    ...
    fileprivate func createMaskCircleLayer() -> CAShapeLayer {
        ...
        CGPathAddRect(maskPath, nil, CGRect(x: 0, y: 0, width: UIScreen.main.bounds.size.width, height: UIScreen.main.bounds.size.height))
